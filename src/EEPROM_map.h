...
#define COOGLEIOT_KONKER_DEVICE_ID_ADDR 821
#define COOGLEIOT_KONKER_DEVICE_ID_MAXLEN 50 // 821 - 871

#define COOGLEIOT_KONKER_DEVICE_PASSWORD_ADDR 872
#define COOGLEIOT_KONKER_DEVICE_PASSWORD_MAXLEN 50 // 872 - 922
